...
const ChartTwo: React.FC<{ data: { name: string[]; series: number[] } }> = ({ data }) => {
    ...
    responsive: [
      {
        ...
        options: {
          plotOptions: {
            bar: { borderRadius: 0, columnWidth: '75%' },
          },
        },
      },
    ],
  ...
  const series = [{ name: 'Total Klik', data: data.series }];

  return (
    <div className="col-span-12 rounded-sm border border-stroke bg-white p-7.5 shadow-default dark:border-strokedark dark:bg-boxdark xl:col-span-4">
      <div className="mb-4 justify-between gap-4 sm:flex">
        <div>
          <h4 className="text-xl font-semibold text-black dark:text-white">Barang yang sering dilihat</h4>
        </div>
{/*        <div>
